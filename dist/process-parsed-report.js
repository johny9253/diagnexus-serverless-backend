...
const openai = new openai_1.default({
    ...
    baseURL: "https://qhteamopenaikey.openai.azure.com/openai/deployments/gpt-4o-mini",
...
const handler = async (event) => {
    try {
        for (const record of event.Records) {
            ...
            const pdfData = await (0, pdf_parse_1.default)(fileData.Body);
            console.log("✅ Parsed PDF. First 100 chars:", pdfData.text.slice(0, 100));
...
`;
            ...
            for (const test of report) {
                ...
                // Insert into DB
                await database_1.default.query(`INSERT INTO report_test
    ...
    VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9)`, [
            ...
            console.log(`✅ Inserted ${inRangeTests.length} in-range tests and ${outOfRangeTests.length} out-of-range tests into DB`);
            // get user email from patient_id
            const userResult = await database_1.default.query(`SELECT email FROM users WHERE user_id = $1`, [patientId]);
            ...
            await (0, sendEmail_1.sendReportEmail)(userEmail, outOfRangeTests, inRangeTests);
        }
    }
    catch (err) {
